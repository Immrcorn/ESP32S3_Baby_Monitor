...
void startCameraServer() {
  ...
  httpd_uri_t level_uri = {.uri = "/level",
                           .method = HTTP_GET,
                           .handler = level_handler,
                           .user_ctx = NULL};

  httpd_uri_t set_threshold_uri = {.uri = "/set",
                                   .method = HTTP_GET,
...
// ========================================================================
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(camera_httpd, &level_uri);
    httpd_register_uri_handler(camera_httpd, &set_threshold_uri);
